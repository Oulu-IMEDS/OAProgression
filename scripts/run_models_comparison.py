...
if __name__ == "__main__":
    ...
    fig, axs = init_auc_pr_plot(dl_preds.Progressor.values)
    for key, color in zip(['logreg_age_sex_bmi_kl_surg_inj_womac', 'dl'], ['blue', 'red']):        
        tmp_df = models[key]
        compute_and_plot_curves(tmp_df, axs, legend=False, color=color)
    ...
    fig, axs = init_auc_pr_plot(dl_preds.Progressor.values)
    for key, color in zip(['logreg_age_sex_bmi_kl_surg_inj_womac', 'lgbm_stacking_no_kl'], ['blue', 'red']):        
        tmp_df = models[key]
        compute_and_plot_curves(tmp_df, axs, legend=False, color=color)
